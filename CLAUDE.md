# CLAUDE.md — devpath-sandbox-svc

> Sandbox Runner — 사용자 코드를 격리 실행하는 서비스
...
- 패키지: `ai.devpath.sandbox` / 메인: `SandboxApplication`
- 보안상 코어와 무조건 분리된 격리 서비스. 실행은 네트워크 차단 + 리소스 제한 + gVisor 샌드박스로 구동한다.
